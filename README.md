...
|---|---|---|
| **Soko Selowansyah** (15196250463) | Data Engineer | Ekstraksi API, pembersihan data (*cleaning*), EDA, visualisasi awal |
|  | Estimation Analyst | Kalkulasi MLE (Poisson/Bernoulli), konjugasi Beta Posterior, visualisasi *likelihood* |
| | Inference Analyst | Perhitungan rentang ketidakpastian (*Confidence & Credible Intervals*) |
| | Hypothesis Analyst | Uji hipotesis Z-Test, penetapan H0/H1, interpretasi keputusan *p-value* |
| | Computation Analyst | Prediksi dengan Simulasi Monte Carlo, optimasi Bloom Filter, MCMC |
